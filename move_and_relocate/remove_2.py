...
week_report = openpyxl.load_workbook('D:/software/python/python_excel/move_and_relocate/copy_data/亲子周报2024-05-20-2024-05-26.xlsx')
...
# ...
week_pivot_table = openpyxl.load_workbook('D:/software/python/python_excel/move_and_relocate/copy_data/亲子周报透视数据2024-05-20_2024-05-26.xlsx')
...
week_country = openpyxl.load_workbook('D:/software/python/python_excel/move_and_relocate/copy_data/站点商品数据2024-05-20_2024-05-26.xlsx')
...
# 新老品销量层级
excel_tool.copy_data(week_report_family_data, week_report_family_data, 75, 3, 97, 3, 19, 15)
...
week_report.save('D:/software/python/python_excel/move_and_relocate/copy_data/亲子周报2024-05-20-2024-05-26.xlsx')
